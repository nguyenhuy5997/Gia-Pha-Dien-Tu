    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2 px-4 py-4 border-b">
                ...
                {!collapsed && <span className="font-bold text-lg">Gia phả họ Lê Vũ Công Thần</span>}
            </div>
            ...
            {!collapsed && (
                <div className="border-t px-4 py-3">
                    <p className="text-xs text-muted-foreground leading-relaxed">
                        Mọi đóng góp thông tin về dòng họ Lê Vũ Công Thần xin liên hệ
                        <br />
                        Đào Nguyên Huy 
                        <span className="font-semibold text-foreground">📞 0964 953 329</span>
                        <br />
                    </p>
                </div>
            )}
